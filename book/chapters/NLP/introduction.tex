...
In this chapter, we will provide a foundational knowledge to the building blocks of computational linguistics, starting with how machines represent text. We will
expand upon this with an introduction into more advanced machine learning models, and ultimately into state-of-the-art NLP models such as GPT4\cite{openai2023gpt4}. Along the way,
coding examples and real-world examples will be presented to help to understand the ways that this field continues to be used by clinicans and researches in the field of epilepsy.
