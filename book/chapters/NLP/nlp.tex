...
%TODO - add some epilepsy-themed tokenization example here with spacy or stanford NLP or BERT tokenization, etc. Make sure it adds EOS, isolates period, maybe has a number
