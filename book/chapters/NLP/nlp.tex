...
Our context input then becomes:
\begin{equation}
  \sum_{ \substack {j=-c \\ j \neq 0}}^c w_{i+j}
\end{equation}
...
\begin{itemize}
  ...
  Our \textit{patient} embedding will also capture this meaning in our model, dependent upon how often that meaning is used.
...
This is placeholder text.
Would BioBERT and \textit{Bio\textunderscore ClinicalBERT} here be worth mentioning?
