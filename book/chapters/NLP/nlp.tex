...
\subsubsection{Spacy Example of Word Embeddings}
...
Studies have already been done applying this strategy\cite{10.1093/jamia/ocac018}, using three pre-trained neural language models, \texttt{Bio\textunderscore ClinicalBERT}, to extract
seizure frequency from epilepsy clinical notes.
...
\input{chapters/NLP/research_process.tex}
